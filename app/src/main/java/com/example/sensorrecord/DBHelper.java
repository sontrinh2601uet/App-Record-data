...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "dataMining.db";
    ...
    private static final String SUBJECTS_RESEARCH_ASSISTANT = "RA";
    private static final String SUBJECTS_ID = "id";
    private static final String SUBJECTS_CONDITION = "condition";
    private static final String SUBJECTS_AGE = "age";
    private static final String SUBJECTS_SEX = "sex";
    ...
    private static final String DATA_GRAVX = "gravX";
    private static final String DATA_GRAVY = "gravY";
    private static final String DATA_GRAVZ = "gravZ";
    private static final String DATA_MAGX = "magX";
    private static final String DATA_MAGY = "magY";
    private static final String DATA_MAGZ = "magZ";
    ...
    public void insertSubjectTemp(String date, String name,
                                  String job, Short age,
                                  String sex, String version, long time) throws SQLException {

        ContentValues subjectData = new ContentValues();
        subjectData.put(SUBJECTS_DATE, date);
        subjectData.put(SUBJECTS_RESEARCH_ASSISTANT, name);
        subjectData.put(SUBJECTS_CONDITION, job);
        subjectData.put(SUBJECTS_AGE, age);
        subjectData.put(SUBJECTS_SEX, sex);
        subjectData.put(SUBJECTS_HEIGHT, version);
    ...
    public void insertDataTemp(long time,
                               float[] acc,
                               float[] gyro,
                               float[] mag,
